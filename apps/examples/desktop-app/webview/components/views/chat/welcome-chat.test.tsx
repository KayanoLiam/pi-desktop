...
const { invokeMock, subscribeMock, openExternalUrlMock } = vi.hoisted(() => ({
	invokeMock: vi.fn(
...
describe("WelcomeScreen", () => {
	it("shows the composer without Cline sign-in or account checks on first run", async () => {
		...
		expect(container.textContent).not.toMatch(/Sign in|Log in|Create account/);
		expect(
